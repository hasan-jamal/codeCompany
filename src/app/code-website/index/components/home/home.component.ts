...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  // ============== إعدادات فيديوهات التبويبات (Tabs) =================
...
allVideos: VideoData[] = [
    { 
      id: 'security', 
      title: 'VIDEOSSelected.security.title', 
      description: 'VIDEOSSelected.security.description', 
      videoId: 'DYw5zcyK4-Q' 
    },
    { 
      id: 'facility', 
      title: 'VIDEOSSelected.facility.title', 
      description: 'VIDEOSSelected.facility.description', 
      videoId: 'kOHvcztXQfI' 
    },
    { 
      id: 'infrastructure', 
      title: 'VIDEOSSelected.infrastructure.title', 
      description: 'VIDEOSSelected.infrastructure.description', 
      videoId: 'xDCoSkrLUwA' 
    },
    { 
      id: 'commandCenter', 
      title: 'VIDEOSSelected.commandCenter.title', 
      description: 'VIDEOSSelected.commandCenter.description', 
      videoId: 'R6mxF1WwrU8' 
    }
  ];
...
shouldPlayOnReady: boolean = false; 
  onVideoSelect(selectedVideo: VideoData) {
    if (this.mainVideoTabs.videoId === selectedVideo.videoId) return;
    ...
    onMainPlayerReady(event: YT.PlayerEvent) {
